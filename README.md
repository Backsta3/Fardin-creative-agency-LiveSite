...
## Creative Agency
This is an online service purchase website.
## Used App:
React, JavaScript(ES6), MongoDB, React-Router, Firebase, Html, CSS
## Features
Different panel for User and Admin Panel and fully protected admin panel. Adding Service Option, admin
adding option for an Admin. Adding reviews option for user and fully responsive with sign-in/up feature.
## Live Link: https://fardin-ist-creative-agency.web.app/
<br />
<br />
